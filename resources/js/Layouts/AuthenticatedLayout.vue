...
const menuItems = [
    ...
    },
    {
        ...
        items: [
            ...
            { title: 'Tour Packages', route: 'admin.tour-packages.index', icon: 'M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4' },
    ...
    },
    {
        group: 'Bookings',
        items: [
            { title: 'All Bookings', route: 'admin.bookings.index', icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2' },
        ],
    },
    {
        group: 'Contact',
        items: [
            ...
            { title: 'Messages', route: 'admin.contact-messages.index', icon: 'M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z' },
