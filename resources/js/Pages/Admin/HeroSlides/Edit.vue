...
const form = useForm({
    ...
    label: props.heroSlide.label || '',
    subtitle: props.heroSlide.subtitle || '',
    description: props.heroSlide.description || '',
    cta_label: props.heroSlide.cta_label || '',
    cta_url: props.heroSlide.cta_url || '#safaris',
    position: props.heroSlide.position || 0,
    is_active: props.heroSlide.is_active ?? true,
    image_base64: props.heroSlide.image_base64 || null,
});

const imagePreview = ref(
    props.heroSlide.image_base64 || 
    (props.heroSlide.media && props.heroSlide.media[0]
        ? props.heroSlide.media[0].original_url
        : null)
);
...
const submit = () => {
    form.put(route('admin.hero-slides.update', props.heroSlide.id));
};
</script>
