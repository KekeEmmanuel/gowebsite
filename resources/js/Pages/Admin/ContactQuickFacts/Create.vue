...
const submit = () => {
    form.post(route('admin.contact-quick-facts.store'));
};
</script>

<template>
    <Head title="Create Contact Quick Fact" />
            ...
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="text-2xl font-bold leading-tight text-gray-900">
                        Create Contact Quick Fact
                    </h2>
                    <p class="mt-1 text-sm text-gray-500">
                        Add a new quick fact to the "Why Choose Us" section
                    </p>
                </div>
                <Link
