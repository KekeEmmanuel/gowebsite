...
$filesToCopy = [
    ...
    'app/Models/TourPackage.php' => 'TourPackage model with conditional conversions',
    'app/Models/SafariPackage.php' => 'SafariPackage model with conditional conversions',
